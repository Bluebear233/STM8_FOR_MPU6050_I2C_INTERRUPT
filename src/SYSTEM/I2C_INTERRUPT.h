...
unsigned char I2C_Get_Communication_Complete(void);
unsigned char I2C_Multiple_Write_Without_Block(unsigned char slave_address,
		unsigned char reg_address, unsigned char *data_point,
		unsigned char data_len);
unsigned char I2C_Multiple_Read_Without_Block(unsigned char slave_address,
		unsigned char reg_address, unsigned char *data_point,
		unsigned char data_len);
